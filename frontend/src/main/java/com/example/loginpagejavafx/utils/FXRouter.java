package com.example.loginpagejavafx.utils;
...
import com.example.loginpagejavafx.Main;
...
public final class FXRouter {
    ...
    private static class RouteScene {
         ...
         *
         * @param scenePath: .FXML scene file that is relative Main Class package path (e.g. "loginView/login.fxml" loginView is a folder in the ressources folder)
         * @param styleSheetPath: .css scene file that is relative Main Class package path (e.g. "loginView/login-styles.css" loginView is a folder in the ressources folder)
         * @param windowTitle: Scene (Stage) title
         * @param sceneWidth:  Scene Width
         * @param sceneHeight: Scene Height
         */
        private RouteScene(String scenePath, String windowTitle, double sceneWidth, double sceneHeight,String styleSheetPath) {
    ...
    public static void when(String routeLabel, String scenePath, double sceneWidth, double sceneHeight,String styleSheetPath) {
    ...
    private static void loadNewRoute(RouteScene route) throws IOException {
        ...
        URL resourceURL = Main.class.getResource(scenePath);

        File resourceFile = new File(resourceURL.getPath());

        Parent resource = FXMLLoader.load(resourceFile.toURI().toURL());
        ...
        window.getScene().getStylesheets().add(Main.class.getResource(sceneStyleSheetPath).toExternalForm());
        // show the window
        window.show();
