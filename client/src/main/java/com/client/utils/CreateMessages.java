 ...
 * first is called <code>sendMessage()</code> used to make a UI send message
 * style
 * in the main VBox Node....<br>
 * second is called <code>receiveMessage()</code> and used to make a UI receive
 * message style
...
public class CreateMessages {
     ...
     * @param event          is an event handler to add some actions when OPTIONS
     *                       BUTTON clicked.
     */
