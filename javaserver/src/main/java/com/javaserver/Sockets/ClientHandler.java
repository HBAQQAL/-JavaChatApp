package com.javaserver.Sockets;
...
import com.javaserver.model.SocketMessage;
...
public class ClientHandler extends Thread {
    ...
    public void getUserId() {
        try {
            SocketMessage m = new SocketMessage("pleasesetid", "server", "client", "connection");
            sendMessage(m);
        } catch (Exception e) {
    ...
    public void handleMessage(String message) {
        try {
            SocketMessage m = gson.fromJson(message, SocketMessage.class);
            ...
            if (m.getReceiver().equals("server")) {
                ...
                if (m.getType().equals("file")) {
                    ...
                    SocketMessage fileMessage = new SocketMessage(fileName, m.getSender(),
                            m.getReceiver(), "file");
                    System.out.println("sending file message named " + fileMessage.getMessage());
